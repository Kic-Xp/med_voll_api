...
class ConsultasControllerTest {
	...
	@Test
	@DisplayName("Deve Devolver codigo 400 quando nao tiver nada na requisição")
	void testCadastraConsulta() throws Exception {
	...
	@Test
	@DisplayName("Deve Devolver codigo 200 e devolver o objeto quando tiver dados na requisição")
